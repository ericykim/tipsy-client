    ...
    return (
        <div className='container'>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Tipsy, accessible from{' '}
                        <a href='www.tipsy.buzz' rel='external nofollow noopener' target='_blank'>
                            www.tipsy.buzz
                        </a>
                    </p>
                </li>
            ...
            <ul>
                <li>By email: ericykim5399@gmail.com</li>
            </ul>
        </div>
    );
};
